...
public class MaintenanceOrderController {
    ...
    public ResponseData<MaintenanceOrderResponse> create(@RequestBody MaintenanceOrderRequest request) {
        ...
        return ResponseData.<MaintenanceOrderResponse>builder().status(200).message("Thành công").data(maintenanceOrderMapper.toResponse(saved)).build();
    }
    ...
    public ResponseData<MaintenanceOrderResponse> update(@PathVariable UUID id, @RequestBody MaintenanceOrderRequest request) {
        ...
        return ResponseData.<MaintenanceOrderResponse>builder().status(200).message("Thành công").data(maintenanceOrderMapper.toResponse(updated)).build();
    }
    ...
    public ResponseData<MaintenanceOrderResponse> getById(@PathVariable UUID id) {
        ...
        return ResponseData.<MaintenanceOrderResponse>builder().status(200).message("Thành công").data(entity != null ? maintenanceOrderMapper.toResponse(entity) : null).build();
    }
    ...
    public ResponseData<Page<MaintenanceOrderResponse>> filter(@RequestBody BaseFilterRequest filter) {
        ...
        return ResponseData.<Page<MaintenanceOrderResponse>>builder().status(200).message("Thành công").data(page).build();
    }
