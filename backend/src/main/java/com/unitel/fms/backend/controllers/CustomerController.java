...
public class CustomerController {
    ...
    public ResponseData<CustomerResponse> create(@Valid @RequestBody CustomerRequest request) {
        ...
        return ResponseData.<CustomerResponse>builder().status(200).message("Thành công").data(customerMapper.toResponse(saved)).build();
    }
    ...
    public ResponseData<CustomerResponse> update(@PathVariable UUID id, @Valid @RequestBody CustomerRequest request) {
        ...
        return ResponseData.<CustomerResponse>builder().status(200).message("Thành công").data(customerMapper.toResponse(updated)).build();
    }
    ...
    public ResponseData<CustomerResponse> getById(@PathVariable UUID id) {
        ...
        if (entity == null) {
            return ResponseData.<CustomerResponse>builder().status(404).message("Không tìm thấy").build();
        }
        return ResponseData.<CustomerResponse>builder().status(200).message("Thành công").data(customerMapper.toResponse(entity)).build();
    }
    ...
    public ResponseData<List<CustomerResponse>> getAll() {
        ...
        return ResponseData.<List<CustomerResponse>>builder().status(200).message("Thành công").data(list).build();
    }
    ...
    public ResponseData<Page<CustomerResponse>> filter(@RequestBody BaseFilterRequest filter) {
        ...
        return ResponseData.<Page<CustomerResponse>>builder().status(200).message("Thành công").data(page).build();
    }
