...
public class UserController {
    ...
    public ResponseData<UserResponse> create(@RequestBody UserRequest request) {
        ...
        return ResponseData.<UserResponse>builder().status(200).message("Thành công").data(userMapper.toResponse(saved)).build();
    }
    ...
    public ResponseData<UserResponse> update(@PathVariable UUID id, @RequestBody UserRequest request) {
        ...
        return ResponseData.<UserResponse>builder().status(200).message("Thành công").data(userMapper.toResponse(updated)).build();
    }
    ...
    public ResponseData<UserResponse> getById(@PathVariable UUID id) {
        ...
        return ResponseData.<UserResponse>builder().status(200).message("Thành công").data(entity != null ? userMapper.toResponse(entity) : null).build();
    }
    ...
    public ResponseData<List<UserResponse>> getAll() {
        ...
        return ResponseData.<List<UserResponse>>builder().status(200).message("Thành công").data(list).build();
    }
    ...
    public ResponseData<Page<UserResponse>> filter(@RequestBody BaseFilterRequest filter) {
        ...
        return ResponseData.<Page<UserResponse>>builder().status(200).message("Thành công").data(page).build();
    }
