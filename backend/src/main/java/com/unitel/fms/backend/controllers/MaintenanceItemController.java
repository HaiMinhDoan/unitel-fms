...
public class MaintenanceItemController {
    ...
    public ResponseData<MaintenanceItemResponse> create(@RequestBody MaintenanceItemRequest request) {
        ...
        return ResponseData.<MaintenanceItemResponse>builder().status(200).message("Thành công").data(maintenanceItemMapper.toResponse(saved)).build();
    }
    ...
    public ResponseData<MaintenanceItemResponse> update(@PathVariable UUID id, @RequestBody MaintenanceItemRequest request) {
        ...
        return ResponseData.<MaintenanceItemResponse>builder().status(200).message("Thành công").data(maintenanceItemMapper.toResponse(updated)).build();
    }
    ...
    public ResponseData<MaintenanceItemResponse> getById(@PathVariable UUID id) {
        ...
        return ResponseData.<MaintenanceItemResponse>builder().status(200).message("Thành công").data(entity != null ? maintenanceItemMapper.toResponse(entity) : null).build();
    }
    ...
    public ResponseData<Page<MaintenanceItemResponse>> filter(@RequestBody BaseFilterRequest filter) {
        ...
        return ResponseData.<Page<MaintenanceItemResponse>>builder().status(200).message("Thành công").data(page).build();
    }
    ...
    public ResponseData<java.util.List<MaintenanceItemResponse>> getByOrder(@PathVariable UUID orderId) {
        ...
        return ResponseData.<java.util.List<MaintenanceItemResponse>>builder().status(200).message("Thành công").data(list).build();
    }
}
