...
public class VehicleController {
    ...
    public ResponseData<VehicleResponse> getById(@PathVariable UUID id) {
        ...
        return ResponseData.<VehicleResponse>builder().status(200).messageCode("SUCCESS").data(entity != null ? vehicleMapper.toResponse(entity) : null).build();
    }
    ...
    public ResponseData<List<VehicleResponse>> getAvailableForDispatch() {
        ...
        return ResponseData.<List<VehicleResponse>>builder().status(200).messageCode("SUCCESS").data(list).build();
    }
    ...
    public ResponseData<com.unitel.fms.backend.dtos.response.DispatchEligibilityResult> checkDispatchEligibility(@PathVariable UUID id) {
        ...
        return ResponseData.<com.unitel.fms.backend.dtos.response.DispatchEligibilityResult>builder().status(200).messageCode("SUCCESS").data(result).build();
    }
}
